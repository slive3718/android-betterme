...
public class DietDetailsAdapter extends RecyclerView.Adapter {
    ...
    public DietDetailsAdapter(Context ctx, SetDiets diet, OnClickListener onClickListener) {
        this.context = ctx;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == VIEW_TYPE_HEADER) {
            View view = inflater.inflate(R.layout.custom_diet_header_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof HeaderViewHolder) {
            ((HeaderViewHolder) holder).setDiets(diet);
        } else if (holder instanceof CommentViewHolder) {
            ((CommentViewHolder) holder).setComment(diet.getComments().get(position - 1));
    ...
    public int getItemCount() {
        return diet.getComments().size() + 2; // 1 header 1 footer (write a comment)
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setDiets(SetDiets item) {
            ...
            imagesAdapter.setImages(this.diets.getImages());
